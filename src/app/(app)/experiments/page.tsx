...
import { ExperimentsTopbar } from '@/components/experiments/experiments-topbar';
import { ExperimentsList } from '@/components/experiments/experiments-list';
import { ExperimentDetailPanel } from '@/components/experiments/experiment-detail-panel';
import { ExperimentCreateModal } from '@/components/experiments/experiment-create-modal';
  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col overflow-hidden bg-white dark:bg-zinc-950">
        <ExperimentsTopbar isGuest={isGuest} />

        <div className="flex flex-1 overflow-hidden">
          <div className="min-w-0 flex-1 overflow-hidden">
            <ExperimentsList workspaceId={workspaceId} members={membersList} />
          </div>
